...
Thanks for your interest in improving the Solana NFT Deployer.

## Workflow

1. Fork the repo and create a branch from `main`.
2. Test every change against **devnet** before opening a PR.
...
- One concern per script: `collection.ts`, `deploy.ts`, `mint.ts`, `upload.ts` stay focused.
